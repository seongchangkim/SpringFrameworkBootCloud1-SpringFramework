	...
	<div class ="position-absolute top-50 start-50 translate-middle w-50 h-50">
		...
		<div class="mb-3 row">
    	 ...
    	 <div class="col-sm-10">
  		...
  		<button onclick="location.href='/cloud/admin/updateUserInfoPasswordVerify'" class="btn btn-lg btn-warning">회원 수정</button>
    	<button onclick="location.href='/cloud/admin/deleteUserInfoPasswordVerify'" class="btn btn-lg btn-danger">회원 삭제</button>
	</div>
</body>
</html>